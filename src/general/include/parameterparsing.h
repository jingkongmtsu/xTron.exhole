...
namespace parameterparsing {
	...
	class ParameterParsing {
		...
		protected:
			...
			bool findSection(ifstream& inf, const string& className, const UInt& sec, 
				               bool isCluster);
	...
	class Parameters : public ParameterParsing {
		public: Parameters(const string& input, const UInt& sec);
	};
