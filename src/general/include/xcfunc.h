...
namespace xcfunc {
	...
	class XCFunc {
      ...
      /// Whether to use the one-spin code for the b05 nd for parallel spin.
      /// It affects only the new versins b05 and b13, and kp in cpp.
      /// Default: 0 (false).
      UInt b05NDPar1Spin;
		...
		public:
			...
			UInt getB05NDPar1Spin() const { return b05NDPar1Spin; };
	};
