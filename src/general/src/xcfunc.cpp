...
void XCFunc::setupXCFunc()
{
	...
	for(UInt iFunc=0; iFunc<nFunc; iFunc++) {
		...
		while(getline(inf,line)) {
			...
			// Use the 1 spin code for both spins for ndpar.
			if (keyword == "B05NDPAR1SPIN") {
				string c = l.findValue(1);
				UInt  method;
				if (! w.toUInt(c, method)) {
					cout << line << endl;
				...
				//!! tmp print.
				b05NDPar1Spin = method;
				cout << "MTAG b05NDPar1Spin = " << b05NDPar1Spin << endl;
			}
		}
	}
...
XCFunc::XCFunc(const string& name): b05NDPar1Spin(0), B13CoorMethod(B13COORMETHOD_DEFAULT), 
	B05NDParMethod(B05NDPARMETHOD_DEFAULT),
...
XCFunc::XCFunc(const string& ex, const string& ec):b05NDPar1Spin(0), B13CoorMethod(B13COORMETHOD_DEFAULT), 
	B05NDParMethod(B05NDPARMETHOD_DEFAULT),
	becke05_p(BECKE05_P_DEFAULT),becke05_q(BECKE05_Q_DEFAULT),
	kp14_alpha(KP14_ALPHA_DEFAULT),kp14_b(KP14_B_DEFAULT),kp14_c_ndpar(KP14_C_NDPAR_DEFAULT),
	kp14_c_ndpar_cap(KP14_C_NDPAR_CAP_DEFAULT),
...
XCFunc::XCFunc(const string& input, const UInt& section):b05NDPar1Spin(0), B13CoorMethod(B13COORMETHOD_DEFAULT), 
	B05NDParMethod(B05NDPARMETHOD_DEFAULT),
	becke05_p(BECKE05_P_DEFAULT),becke05_q(BECKE05_Q_DEFAULT),
	kp14_alpha(KP14_ALPHA_DEFAULT),kp14_b(KP14_B_DEFAULT),kp14_c_ndpar(KP14_C_NDPAR_DEFAULT),
	kp14_c_ndpar_cap(KP14_C_NDPAR_CAP_DEFAULT),
