...
namespace molecule { class Molecule; }
namespace xcintsprops { class XCIterInput; }
namespace xcints { class XCInts; }
...
namespace xcintsinfor {
	...
	class XCIntsInfor {
		...
		protected:
			...
			// 
			const Molecule* mol;         //!!Reform. Needs a 2nd look later.
	...
	class XCIntJobInfor : public XCIntsInfor {
		//Reform. temp for access input options and input file name for hole calcn.
		friend class xcintsprops::XCIterInput;
		friend class xcints::XCInts;
