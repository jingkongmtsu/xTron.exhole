		...
		const XCFunc& xcfunc):nGrids(0),nEComponents(0) 
{
	...
	if (exFuncName == "KP14" || 
		exFuncName == "M_KP14" || 
		exFuncName == "KP14_MNDPAR1" || 
		exFuncName == "M_KP14_MNDPAR1" || 
		exFuncName == "KP14_MNDPAR2" ||
		exFuncName == "M_KP14_MNDPAR2" ||
		exFuncName == "M_KP14_MNDPAR1_BR94C" ||
		exFuncName == "M_KP14_MNDPAR1_MBR94C" ||
		exFuncName == "M_KP14_MNDPAR1_MBR94CX0" ||
		exFuncName == "M_KP14_MNDPAR1_MBR94CX1" ||
		exFuncName == "M_KP14_MNDPAR1_MBR94CX2" ) 
	{
...
{
	if (exname == "B13COOR_OPP" || 
		  exname == "BR94COOR_OP" || 
			exname == "BR94C_OP_KP14" || 
		  exname == "M_BR94COOR_OP" || 
		  exname == "M_BR94CORR_OPP_X0" || 
		  exname == "M_BR94CORR_OPP_X1" || 
		  exname == "M_BR94CORR_OPP_X2" )
	return XC_E_PROFILE_B13COOR_OPP;

	if (exname == "B13COOR_PAR" || 
		  exname == "BR94COOR_PAR" )
	  return XC_E_PROFILE_B13COOR_PAR;
	if (exname == "KP14C" || exname == "M_KP14C") {
