...
XCIntsInfor::XCIntsInfor(const GlobalInfor& infor, const Molecule& mole): mol(&mole), 
...
string XCIntsInfor::param(const string& key) const 
{
	return mol->getParam(string("XCINTS.") + key);
}
